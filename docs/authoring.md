...
The complete authoring reference: the definition grammar, every step key, and
the composition/quality features. For the engine's semantics behind these
(the lifecycle, the firing rule, the cascade), see [design.md](design.md).
...
runnable example, and [`design.md` §24](design.md) for the full
...
runnable example, and [`design.md` §26](design.md) for the full
