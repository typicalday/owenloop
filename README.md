...
order. The Owenloop Claude Code and Codex plugins provide six hub-native skills:
...
- [`graduate`](plugins/_skills/graduate/SKILL.md) — turn evidence from a
  completed ephemeral composite into a reusable, policy-conformant library candidate.
- [`plan`](plugins/_skills/plan/SKILL.md) — compile novel multi-domain work into
  a checked, approval-gated ephemeral composite that delegates library playbooks.
